...
The document management API allows users to upload and manage supporting documents (api/README.md).
...
To report bugs/issues/features requests, please file an [issue](https://github.com/bcgov/EDUC-DOCUMENT-MAN-API/issues).
